			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">University Calendar</h4>
			...
			<div class="row row-card-no-pd">
                            ...
                            <div class="card">
									<div class="card-header">
										<div class="card-title">University Calendar</div>
									</div>
									<div class="card-body">
											...
											<table class="table table-bordered">
												...
												<tbody>
                                                                                                    ...
                                                                                                    <%
                                                                                                        int ac = 1000;
                                                                                                        while(ac>=0){
                                                                                                        String sql = "SELECT * FROM `inuncal` WHERE `id` ='"+ac+"'";
