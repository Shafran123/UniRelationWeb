...
<html>
    <head>
        <%
            if ((session.getAttribute("us_id") == null) || (session.getAttribute("us_pass") == "")) {
                response.sendRedirect("us_log.jsp");
            } 
    ...
    <body>
		...
		<div class="main-header">
			<div class="logo-header">
				<a href="us_incalendar.jsp" class="logo">
					Uni-Industry
				</a>
			...
			<div class="sidebar">
				<div class="scrollbar-inner sidebar-wrapper">
					...
					<ul class="nav">
						...
						<li class="nav-item">
							<a href="us_calendar.jsp">
								<i class="la la-keyboard-o"></i>
								<p>My University Calendar</p>
								
							</a>
						</li>
						<li class="nav-item active">
							<a href="us_ideahub.jsp">
								<i class="la la-th"></i>
								<p>Student Area</p>
			...
			<div class="row row-card-no-pd">
                                                                                                        ...
                                                                                                        String sql = "SELECT * FROM `ideahub` WHERE `id` ='"+ac+"'";
                                                                                                                ...
                                                                                                                if (search.next()) {
                                                                                                                    ...
                                                                                                                    String comments = search.getString("comments");
                                                                                                                     ...
                                                                                                                     out.println("<td><form method='post' action='us_adcom.jsp'> <textarea class='form-control' name='comi' id='comment' required></textarea><input type='hidden' name='user' value='"+session.getAttribute("us_name")+"'><br><input type='hidden' name='oldcom' value='" +comments+ "'><input type='hidden' name='idid' value='" +idid+ "'><input type='submit' value='Add'></form></td>");   
                                                                                                                     }
                                                                                                                     else{
                                                                                                                     ...
                                                                                                                     out.println("<td><form method='post' enctype='multipart/form-data' action='us_imgup.jsp'> <input type='file' name='file' required><input type='submit' value='Import Image'></form></td></tr>");
							...
							<div class="col-md-6">
								<div class="card">
									...
									<div class="card-body">
                                        <form method="post" action="us_addidea.jsp">
										<div class="form-group">
                                                                                    <label for="date">Feed</label>
											<input type="hidden" name="user" value="<%=session.getAttribute("us_name")%>">
