...
<html>
    <head>
        <%
            if ((session.getAttribute("un_id") == null) || (session.getAttribute("un_pass") == "")) {
                response.sendRedirect("un_log.jsp");
            } 
    ...
    <body>
		...
		<div class="main-header">
			<div class="logo-header">
				<a href="un_incalendar.jsp" class="logo">
					Uni-Industry
				</a>
					...
					<div class="user">
						...
						<div class="info">
							<a class="" data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									<%=session.getAttribute("un_name")%>  
									<span class="user-level">University</span>
			...
			<div class="row row-card-no-pd">
											...
											<table class="table table-bordered">
												...
												<tbody>
                                                                                                    ...
                                                                                                    <%
                                                                                                        int ac = 1000;
                                                                                                        while(ac>=0){
                                                                                                        String sql = "SELECT * FROM `inuncal` WHERE `id` ='"+ac+"' AND `uniid` = '"+session.getAttribute("un_id")+"'";
                                                                                                                ...
                                                                                                                if (search.next()) {
                                                                                                                    ...
                                                                                                                    String university = search.getString("university");
                                                                                                                    ...
                                                                                                                    String dis = search.getString("dis");
                                                                                                                     ...
                                                                                                                     out.println("<td><form method='post' action='un_mycaldis.jsp'> <textarea class='form-control' name='comi' id='comment' required></textarea><input type='hidden' name='user' value='"+session.getAttribute("un_name")+"'><br><input type='hidden' name='oldcom' value='" +dis+ "'><input type='hidden' name='idid' value='" +id+ "'><input type='submit' value='Add'></form></td></tr>");
							...
							<div class="col-md-6">
								<div class="card">
									...
									<div class="card-body">
                                        <form method="post" action="un_addevent.jsp">
										<div class="form-group">
                                                                                    <label for="date">Event Date</label>
											<input type="hidden" name="industry" value="<%=session.getAttribute("un_name")%>">
                                                                                        <input type="hidden" name="uniid" value="<%=session.getAttribute("un_id")%>">
