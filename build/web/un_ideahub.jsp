			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">SOFT225SL</h4>
                                                                                                        ...
                                                                                                        String sql = "SELECT * FROM `ideahub` WHERE `id` ='"+ac+"'";
                                                                                                                ...
                                                                                                                if (search.next()) {
                                                                                                                    ...
                                                                                                                    String comments = search.getString("comments");
                                                                                                                     ...
                                                                                                                     out.println("<td><form method='post' action='un_adcom.jsp'> <textarea class='form-control' name='comi' id='comment' required></textarea><input type='hidden' name='user' value='"+session.getAttribute("un_name")+"'><br><input type='hidden' name='oldcom' value='" +comments+ "'><input type='hidden' name='idid' value='" +idid+ "'><input type='submit' value='Add'></form></td>");   
                                                                                                                     }
                                                                                                                     else{
                                                                                                                     ...
                                                                                                                     out.println("<td><form method='post' enctype='multipart/form-data' action='un_imgup.jsp'> <input type='file' name='file' required><input type='submit' value='Import Image'></form></td></tr>");
